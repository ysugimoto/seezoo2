		...
		Module.ready('ui', function() {
			...
			sortHandle = new Module.sortable({
				...
				judge       : function(e, point) {
					...
					if ( DOM(e).first().hasClass('overlay-short') ) {
						return ( point === 'after' ) ? false : true;
					} else if ( next && ! next.hasClass('sz_content_blocks') ) {
						return false;
					} else if ( DOM(e).hasClass('cmsi_add_block') && point === 'after') {
						return false;
					}
					return true;
				}
