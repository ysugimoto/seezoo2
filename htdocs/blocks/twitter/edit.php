...
<dl>
	...
	<dd><?php echo form_input(array('name' => 'user_name', 'id' => 'user_name', 'class' => 'ime_dis', 'value' => $controller->user_name));?></dd>
	<dt><label for="view_limit">表示件数</label></dt>
	<dd><?php echo form_input(array('name' => 'view_limit', 'id' => 'ivew_limit', 'size' => 2, 'value' => $controller->view_limit));?></dd>
</dl>
</div>