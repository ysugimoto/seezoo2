...
class PendingPagesActiveRecord extends SZ_ActiveRecord
{
	protected $_table   = 'pending_pages';
	protected $_primary = 'pending_page_version_id';
	protected $_schemas = array(
		'pending_page_version_id' => array('type' => 'INT'),
	...
	public function isValidPendingPageVersionId($value) {
		return TRUE;
	}
