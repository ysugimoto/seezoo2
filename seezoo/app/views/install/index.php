        ...
        <div id="container_full">
         ...
         <div class="permission_error">
           ...
           <a href="javascript:void(0)" id="reload">
             <?php echo $Helper->install->setInstallIcons('back.png', $siteUri);?>&nbsp;再チェック
           </a>
         </div>
         ...
         <?php endif;?>
           ...
           <div id="input_install_data">
             ...
             <p id="login_btn">
               ...
               <?php endforeach; ?>
               <input type="submit" alt="インストール" value="seezooをインストール!" id="btn" disabled="disabled" tabindex="<?php echo ++$cnt;?>" />
             </p>
